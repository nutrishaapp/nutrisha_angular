...
export class HungryQuestionService {
  ...
  private api_TummyMakingNoises = environment.baseUrl + '/Admin/api/v1/TummyMakingNoises/GetPagedList?userId=6116';
  private api_FeelingChewy = environment.baseUrl + '/Admin/api/v1/FeelingChewy/GetPagedList?userId=6116';
  private api_EmotionalCrave = environment.baseUrl + '/Admin/api/v1/EmotionalCrave/GetPagedList?userId=6116';
